                        ...
                        .onVisibleChangeListener(new Layer.OnVisibleChangeListener() {
                            ...
                            public void onShow(@NonNull Layer layer) {
                                ...
                                dialogLayer.compatSoftInput(false,
                                        (EditText) layer.getView(R.id.et_dialog_content),
                                        (EditText)  layer.getView(R.id.et_dialog_content1),
                                        (EditText)  layer.getView(R.id.et_dialog_content2),
                                        (EditText)  layer.getView(R.id.et_dialog_content3),
                                        (EditText) layer.getView(R.id.et_dialog_content4),
                                        (EditText)  layer.getView(R.id.et_dialog_content5)
                                );
                            }
